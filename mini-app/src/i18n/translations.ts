export const translations = {
  uk: {
    ...
    book: 'Записатись',
    success: 'Ви записані!',
    successHint: 'Деталі вже в чаті з ботом',
    reminder: 'Нагадаємо за 24 год і за 2 год до візиту',
    myBookings: 'Закрити',
    home: 'Новий запис',
    back: 'Назад',
    min: 'хв',
    ...
    missingSalon: 'Немає ID салону. Відкрийте застосунок з бота.',
    stepService: 'Послуга',
    stepMaster: 'Майстер',
    stepTime: 'Час',
    stepConfirm: 'Готово',
  ...
  en: {
    ...
    successHint: 'Details are in the bot chat',
    reminder: 'We’ll remind you 24h and 2h before',
    myBookings: 'Close',
    home: 'New booking',
    back: 'Back',
    min: 'min',
    ...
    missingSalon: 'Salon ID missing. Open the app from the bot.',
    stepService: 'Service',
    stepMaster: 'Master',
    stepTime: 'Time',
    stepConfirm: 'Done',
